...
const apiKey = "adb57dbe26fd8fa6c4354c7567bdcbcb";
const lang = "kr";
...
document.getElementById('search-button').addEventListener('click', () => {
  ...
  const city = capitalizeCity(cityInput); // 공백덩어리가 아닌지 확인
  ...
  getWeatherData(city);
  document.getElementById('city-input').value = ''; // 입력값 초기화, 등호(=) 하나는 할당임
});
