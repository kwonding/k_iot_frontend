...
document.addEventListener('DOMContentLoaded', () => {
  ...
  completedButton.addEventListener('click', () => {
    ...
    if (allFlipped) {
      ...
      toggleButtonVisibility(false); // 시작 버튼만 보이게 함
    } else {
      alert('완료되지 않았습니다.');
    }
  });
