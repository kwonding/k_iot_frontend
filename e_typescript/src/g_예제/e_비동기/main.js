...
var currentPage = 1; // 현재 페이지 번호를 추적 (기본값1: 첫 페이지)
var photoPerPage = 4; // 한 페이지 당 표시할 사진의 수
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    ...
                    // 2페이지: 4 ~ 7 인덱스
                    // ...
                    // (page - 1) * photoPerPage: 시작인덱스
                    // page * photoPerPage: 끝인덱스 (포함X)
...
//? 사진을 랜더링하는 함수: 4개씩 나누어진 사진 배열을 매개변수로 받음
function renderPhotos(photos) {
    var container = document.getElementById('photo-container');
    // null만 아니면 되니까 그냥 HTMLElement로가져옴
    container.innerHTML = '';
    // 각 사진에 대한 HTML 요소 생성
    photos.forEach(function (photo) {
        var photoElement = document.createElement('div'); // div안에 img 하나, p 하나
