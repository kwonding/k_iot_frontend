...
fetchUserData(1); // Name: Leanne Graham, Email: Sincere@april.biz, Company: Romaguera-Crona
fetchUserData(2); // Name: Ervin Howell, Email: Shanna@melissa.tv, Company: Deckow-Crist
fetchUserData(20); // 네트워크 응답이 실패하였습니다.