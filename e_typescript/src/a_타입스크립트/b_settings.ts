...
1. Node.js 설치
2. 프로젝트 폴더 생성
3. TypeScript 컴파일러(실시간 체킹 불가) 설치(typescript compiler - tsc)
...
//& 3. typescript 설치
// : 타입스크립트 설치 (npm 사용)
// > 타입스크립트 사용을 위해서는 로컬(해당 폴더만) | 전역 환경(컴퓨터 내)에 TS 설치가 필수
// == 설치 방법 == 
