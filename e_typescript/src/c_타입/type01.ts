...
console.log(stringReturn('권', '지애')); // 권지애
...
// undefinedType = 'hello';
// undefinedType = 123;
// : undefined 지정 시 밑의 'hello', 123 전부 오류남. 즉, undefined 여야만 함
...
//    >> 값이 할당되기 전까지 자동으로 any 타입으로 간주 // let unknownData: any
...
//! === 타입 어노테이션 사용 ===
//? 문제 1: 기본 타입 정의하기
// username은 문자열, userAge는 숫자, isSubscribed는 불리언 값으로 정의
let username: string = '권지애';
let userAge: number = 30;
let isSubscribed: boolean = false;

//? 문제 2: 배열 타입 정의하기
// 문자열 배열 fruits와 숫자 배열 numbers를 정의
let fruits: string[] = ['사과', '바나나', '키위'];
let numbers: Array<number> = [1, 2, 3];

//? 문제 3: void 타입을 사용하는 함수 정의하기
// 아무런 값을 반환하지 않고, 매개변수로 받은 메시지를 콘솔에 출력하는 함수 printMessage를 정의
function printMessage를(message: string): void {
  console.log(message);
}