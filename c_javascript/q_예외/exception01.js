...
// >> 오타 수정만으로 해결 가능한 런타임 오류도 많음(구문 오류 아님)
// cf) JS에서는 SyntaxError로 출력되는 오류 이외의 모든 오류가 예외(런타임 오류)로 분류됨
// >> 종류 : TypeError, ReferenceError, RangeError
...
try {
  ...
  // - stack: 에러가 발생한 지점의 호출 스택을 문자열로 반환0
