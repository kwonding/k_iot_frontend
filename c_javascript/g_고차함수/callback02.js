...
//! '배열'의 콜백함수 형태
// : 배열.메서드(콜백함수)
// - 콜백함수를 가지는 배열 메서드는 공통적으로 '배열을 순회함'
...
// value, index, array의 순서만 보장되면 콜백함수의 인자명은 변경 가능
...
cars.forEach(c => console.log(c)); // X
...
cars.filter(function (car) {
  let isCarLengthBiggerThanFour = car.length > 4; // boolean 값 반환
