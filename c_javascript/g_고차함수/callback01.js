...
const funcName3 = () => {}       // 3) 화살표 함수 - function 생략 / 함수명 생략 (선택X)
...
function funcType() {}
console.log(typeof funcType); // function // typeof 연산자: 데이터의 타입을 문자열로 반환
...
// 일반 코드 흐름 로직
function callback1(callbackFunc) { // print 함수가 인자로 전달되면 callbackFunc 매개변수 명으로 사용됨
  for (let i = 0; i < 3; i++) {
    callbackFunc(i + 1); // i의 값은 print 함수의 index 매개변수로 전달 됨
  }
}
...
callback2(3, evenFunc, oddFunc);
callback2(4, evenFunc, oddFunc);