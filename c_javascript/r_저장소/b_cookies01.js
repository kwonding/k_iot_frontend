...
// username=kja; username-kja; userEmail=qwe123
// >> 문자열이기 때문에 직접 파싱 - 배열 반환됨

function getCookie(name) {
  let cookies = document.cookie.split('; ');
  // cf) for in 연산자
  // for (변수종류 변수명 in 객체명(배열)) { ... }
  // >> 객체의 키(key)를 순회
  // >> 사용 권장 대상: 일반 객체
