...
greet1('권지애', 20); // 안녕하세요, 권지애님! 20세 입니다.
greet1(30); // 안녕하세요, 30님! undefined세 입니다.

function greet2(age, name='비회원 고객') {
  console.log(`안녕하세요, ${name}님! ${age}세 입니다.`);
}
greet2(20, '권지애'); // 안녕하세요, 권지애님! 20세 입니다.
greet2(30); // 안녕하세요, 비회원 고객님! 30세 입니다.
...
spreadFunc(1, 2, [1, 2, 3]); // [ [ 1, 2, 3 ] ] // 이중 배열 가능
spreadFunc(1, 2, 3); // [ 3 ]
...
// >> 전달된 인수들을 하나의 배열로 모음 (...spread 연산자 때문)
