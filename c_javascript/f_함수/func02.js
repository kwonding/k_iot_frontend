...
//function 함수명 (매개변수 나열) {
  ...
  //  return 결과값; (생략 가능 - return 값 없는 경우)
  //? 결과값(return, 리턴값): 함수가 작업 완료 후 반환하는 데이터(값) - retrun 키워드로 반환
// }
...
//& 2) 함수 표현식
// : function 키워드 사용, 함수명 선택적 사용
// > '호이스팅'적용 X: 선언(정의) 이전에 호출 불가

/*
함수명을 변수명이 대신함(변수명 써도 무방) >>
...
/*
  ...
  - 조건부 함수 사용 시: 함수 표현식 (function + 함수명 선택)
  - 콜백 함수 사용 시: 화살표 함수 (() => 함수명 X)
*/