...
changeName(computer1); // computer1에 대해서 이름을 바꿈
console.log(computer2); // { name: '엘지' } // computer2도 이름 바뀜
...
console.log(jsonString); // {"title":"백설공주","author":"이승아","publishYear":2025} // JSON 문자열화

// JS 객체의 키값은 "" 따옴표 사용을 생략!
// JSON 문자열의 키값은 반드시 "" 사용 필수!

let book2 = JSON.parse(jsonString);
console.log(book2); // { title: '백설공주', author: '이승아', publishYear: 2025 } // JS 객체화
...
console.log(book2); // { title: '신데렐라', author: '나나나', publishYear: 2025 }
// book2에만 변화있고 book1은 변화없음
...
// 2) delete 연산자
// : 해당 속성을 가진 '키': '값'의 쌍을 삭제시킴
// delete 객체명.키명;
delete book1.title;
console.log(book1); // { author: '이승아', publishYear: 2025 }
