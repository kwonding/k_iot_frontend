...
/* 
  ...
  변수종류 객체명 = {
    ...
    [ 기능 ]
    키4: 함수 선언 (함수 선언식, 표현식, 화살표 함수 모두 가능)
  }
*/
...
console.log(this); // {}: 해당 파일(obj03.js)의 전역 스코프(전역 상태)를 의미
...
function showThis() {
  ...
  // console.log(this.PI); // undefined // 함수가 변수보다 먼저 호이스팅되서 undefined
  console.log(this);
}
...
const person1 = new Person('권지애'); // this가 person1 (person1.name === 이승아)
const person2 = new Person('권재헌'); // this가 person2 (person2.name === 이도경)

console.log(person1.name); // 권지애
console.log(person2.name); // 권재헌
