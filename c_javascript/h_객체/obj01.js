...
function Human(nameParam, ageParam) {
  ...
  // this는 현재 객체 그 자체
  // : 좌항의 .name / .age와 같이 해당 객체 내의 속성에 접근하려고 할 때, 해당 필드(프로퍼티)가 생성됨 = 변수가 선언됨
  this.name = nameParam;
  this.age = ageParam;
...
let person1 = new Human('권지애', 30);
let person2 = new Human('권재헌', 32);

person1.greet(); // Hello, 권지애
person2.greet(); // Hello, 권재헌
