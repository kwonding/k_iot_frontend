...
// clg: console.log(); - snippet 기능 / emmet 아님
// >> 터미널(ctrl + shift + 백틱)
...
const basketball = '농구';
// basketball = 'basketball'; // 상수 재할당 안됨, TypeError: Assignment to constant variable.
...
let hasPotatochip = snacks.includes('포테토칩'); // console.log(snacks.includes'포테토칩'); 같음
...
//? splice() - (시작인덱스, 삭제할개수, 추가아이템들)
// 1) 추가: splice(시작인덱스, 0, 아이템 나열)
//        >> 3번째 인자값이 있으면 추가로 인식!
console.log(fruits); // [ 'mango', 'orange', 'Banana' ]
