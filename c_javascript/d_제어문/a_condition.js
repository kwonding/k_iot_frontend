...
// case의 데이터 유형은 switch 식의 데이터 유형과 일치해야함 !
switch(fruit) {
  case 'apple':
    console.log('사과');
...
// 점수를 변수에 담아
// , 해당 점수가 0미만 100 초과일 경우 '유효한 점수가 아닙니다' //! 첫번째 조건식

// 90점 이상 A
// 80점 이상 B
// 70점 이상 C
// 60점 이상 D
// 그 외 F >> 각 학점의 값을 grade 변수에 대입
