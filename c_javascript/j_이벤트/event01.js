...
// cf) 해당 선택자 요소를 모두 반환 원할 시
// : document.querySelectorAll("선택자");

// cf) on-키워드
// : 이벤트 종류를 웹 문서의 요소에 연결시켜주는 키워드
// - HTML 이벤트 핸들러 속성은 on키워드와 이벤트 사이에 대문자 변환 X
bgButton.onclick = function() {
  const randomColor = randomColorFunc(); // randomColorFunc반환타입 - 문자열
...
buttons.forEach(btn => {
  ...
  // > HTML요소에 해당 이벤트(on 키워드 생략)가 발생하면 콜백함수를 실행
