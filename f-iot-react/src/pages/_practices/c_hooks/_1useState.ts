...
//? 1. useState 훅의 주요 목적은 무엇인가? B
// A. 컴포넌트의 스타일을 변경하기 위해
// B. 컴포넌트의 상태(state)를 관리하기 위해
// C. DOM 요소를 직접 조작하기 위해
// D. API 호출을 수행하기 위해

//? 2. useState는 어디에서만 호출할 수 있는가? C
// A. 일반 함수 내부
// B. 클래스 메서드 내부
// C. React 함수형 컴포넌트 또는 커스텀 훅 내부
// D. JSX 블록 내부

//? 3. useState의 반환값 형태는? B
// A. 단일 값
// B. [상태값, 상태변경함수] 배열
// C. 객체 {state, setState}
// D. Promise 객체

//? 4. 다음 중 useState의 올바른 사용 예시는? A
/*
...
//? 5. useState로 관리되는 값이 변경되면 어떤 일이 일어나는가? B
// A. DOM이 직접 갱신됨
// B. 해당 컴포넌트가 다시 렌더링됨
// C. 전역 상태가 초기화됨
// D. 아무 일도 일어나지 않음
...
//? 9. useState로 객체 상태를 관리할 때 올바른 패턴은? A
/*
