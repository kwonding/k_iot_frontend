...
// cf) Routing(라우팅)
// : 어떤 네트워크 안에서 통신 데이터(화면이동)를 보낼 때 최적의 경로를 선택하는 과정

//? React Router DOM 설치
// npm install react-router-dom (node_modules가 있는 프로젝트 최상단에서 설치)

// +) 설치 후 확인 package.json
...
//& - 새로고침 없이 URL만 변경 (SPA - SinglePageApplication)
...
// cf) React Router v6 이후 <Switch> -> <Routes>로 변경
...
//    children : 중첩 라우트(Nested Route) 정의 가능
...
/*
  ...
  1) /로 시작하는 경우 
      : 메인 Route 경로에서 시작
      : http://localhost:5173    /route/dashboard
