...
//? 사용 목적
// : props drilling을 없애고 상태 소스의 단일 책임(Single Source of Truth) 제공
...
//@ 2. zustand
// - 장점) 간결한 API(코드가 간결), 부분 구독, 미들웨어 사용 가능, 타입스크립트 친화적
...
const ExampleHeader = () => {
  ...
  if (!user) {
    return <button onClick={() => setUser({name: '권지애'})}>로그인</button>
  }
