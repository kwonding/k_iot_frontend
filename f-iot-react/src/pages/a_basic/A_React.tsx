...
// export default function A_react() {
//   return (
//     <div>A_react</div>
//   )
// }

//! rfce: 리액트 함수형 컴포넌트 생성
// import React from 'react'
...
? '컴포넌트' 기반
: UI를 독립적으로 "재사용 가능한 여러 컴포넌트"로 분리하여 사용
...
? '리액트'를 사용한 SPA 구현
- 가상 돔(Virtual DOM): 페이지 전체를 새로 고침하지 않고 필요한 부분만 업데이트 (화면 변경 부분만 빠르게 업데이트)
- 라우팅 (Routing): 페이지 간의 전환을 'React Router' 라이브러리를 통해서 구현 (페이지 간 전환 관리)
*/