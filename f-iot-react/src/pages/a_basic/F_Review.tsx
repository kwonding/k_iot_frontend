// React 스니펫
// : rfce(함수형 컴포넌트 생성 + export default 내보내기 // react function component export)
...
// cf) 사용자 인터페이스(UI)
// : 사용자와 컴퓨터 시스템 사이의 의사소통 매개체 (즉, 화면!)
...
// 1) 단일 루트 노트
// : 최상단 루트 태그 존재
// - 최상단에 형제 태그 있을 수 없음! (반드시 하나의 부모가 필요하다)
// - <></> 빈 Fragment 태그를 사용
...
// 3) 대소문자 구분
// - 소문자 태그: HTML 요소로 인식
// - 대문자 태그: 사용자 정의 '컴포넌트(UI)'로 인식
//      >> 사용자 정의 <Img /> 태그가 오류 나는 상황
//          - 1) 해당 컴포넌트를 생성하지 않음
//          - 2) 해당 컴포넌트를 import 하지 않거나 잘못됨
