...
const initialFormData: FormData = { // 객체
  id: '',
  password: '',
  confirmPassword: '',
  email: ''
        ...
        <div>
          <label>
            ...
            <input 
              type="text"
              name='id'
              value={formData.id} // {id}가능 - 구조분해할당했으니까
              onChange={handleSignUpInputChange}
            />
          </label>
          {/* error 객체에 해당 속성이 있으면 에러 출력 - 논리연산자 */}
          {/* 
            p태그 외부 소괄호 생략 가능
            : JSX 안에서 한 줄 짜리 표현식은 () 소괄호 안 감싸도 됨!
              여러 줄인 경우 () 필수!
          */}
